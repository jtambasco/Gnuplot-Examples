...
\begin{figure}[!htbp]
\begin{center}
	\resizebox{\columnwidth}{!}{\input{../Code/11cTRAngle_Plot/11cTRAngle}}
...
\begin{figure}[!htbp]
\begin{center}
\resizebox{\columnwidth}{!}{\input{../Code/FFT/FFT}}
...
\begin{figure}[!htbp]
\begin{center}
\resizebox{\columnwidth}{!}{\input{../Code/MaxMinVoltages/MaxMinVoltages}}
\caption{Maximum and minimum output voltage as well as a sweep of $v_\mathit{in}$ showing its affect on $V_\mathit{DS}$.}
...
\begin{figure}[!htbp]
\begin{center}
\resizebox{\columnwidth}{!}{\input{../Code/Motor/Motor}}
...
\begin{figure}[htbp]
\begin{center}
\resizebox{\columnwidth}{!}{\input{../Code/MosfetClassAbPower/MosfetClassAbPower}}
...
\begin{figure}[htbp]
\begin{center}
\resizebox{\columnwidth}{!}{\input{../Code/MosfetClassAbPowerFixed/MosfetClassAbPowerFixed}}
